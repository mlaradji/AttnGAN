...
class BlockBlobServiceEmulator(object):
    """Emulates Azure's BlockBlobService object. Incomplete."""

    def create_blob_from_stream(
        self, container_name: str, blob_name: str, stream: io.BytesIO
    ) -> None:
        save_path = Path(container_name) / blob_name
        save_path.write_bytes(stream)
...
if __name__ == "__main__":
    ...
    blob_service = BlockBlobServiceEmulator()
